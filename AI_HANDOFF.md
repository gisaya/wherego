...
1. Reconnect the Android device and verify `[wherego:reward-ad] load requested -> loaded -> show event` in logcat using the Apps in Toss dev server; development should use the official test ad IDs automatically.

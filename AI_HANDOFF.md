...
- 백엔드 Wherego 테스트 109개와 Python compileall 통과
- 장거리 실패 조합은 원후보 40개, 압축 11개, Gemini 후보 5개로 재현 성공했으며 모두 최소 거리 조건을 충족
- 운영 Render 대상 커밋: `7133ae6`
- 운영 질문 API는 원천 버전 `2026-07-18`을 포함한 7문항과 지역 메타데이터를 반환
- Android/iOS AIT 빌드 0 errors, 0 warnings 완료
- 최신 AIT deploymentId: `019f7e66-4073-7188-abea-02034e1e7280`
